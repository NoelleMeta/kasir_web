...
<<<<<<< HEAD
                ...
                const respSummary = await fetch('/api/v1/dashboard/monthly-summary', { headers: { 'X-Requested-With': 'XMLHttpRequest' }});
                ...
                const respProducts = await fetch('/api/v1/dashboard/top-products', { headers: { 'X-Requested-With': 'XMLHttpRequest' }});
